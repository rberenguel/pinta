...
3.  **Improved Loading of "Bare-bones" Markdown:**
    ...
    - A new `autoPositionHint` was added by the Markdown parser to flag implicitly positioned children. The loading logic (`adjustChildrenLayoutForEvenSplit` in `js/files.js`) uses this hint to evenly distribute children along their parent line if _all_ children of that parent were implicitly positioned.
